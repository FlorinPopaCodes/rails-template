...
module InertiaRails
  class << self
    ...
    #
    # source://inertia_rails//lib/inertia_rails/precognition.rb#62
...
class InertiaRails::Configuration
  ...
  # source://inertia_rails//lib/inertia_rails/configuration.rb#122
  def always_include_errors_hash; end

  # source://inertia_rails//lib/inertia_rails/configuration.rb#126
  ...
  # source://inertia_rails//lib/inertia_rails/configuration.rb#112
  ...
  # source://inertia_rails//lib/inertia_rails/configuration.rb#116
  ...
  #
  # source://inertia_rails//lib/inertia_rails/configuration.rb#77
  def options; end

  private

  # source://inertia_rails//lib/inertia_rails/configuration.rb#133
  ...
  class << self
    ...
    # source://inertia_rails//lib/inertia_rails/configuration.rb#66
    def env_options; end
  end
end
...
# source://inertia_rails//lib/inertia_rails/configuration.rb#57
InertiaRails::Configuration::OPTION_NAMES = T.let(T.unsafe(nil), Array)

# source://inertia_rails//lib/inertia_rails/controller.rb#11
module InertiaRails::Controller
  ...
  # source://inertia_rails//lib/inertia_rails/controller.rb#145
  def inertia_meta; end

  # source://inertia_rails//lib/inertia_rails/controller.rb#140
  def redirect_to(options = T.unsafe(nil), response_options = T.unsafe(nil)); end

  private

  # source://inertia_rails//lib/inertia_rails/controller.rb#227
  def capture_inertia_session_options(options); end

  # source://inertia_rails//lib/inertia_rails/controller.rb#216
  def inertia_collect_flash_data; end

  # source://inertia_rails//lib/inertia_rails/controller.rb#180
  def inertia_configuration; end

  # source://inertia_rails//lib/inertia_rails/controller.rb#211
  def inertia_location(url); end

  # source://inertia_rails//lib/inertia_rails/controller.rb#184
  def inertia_shared_data; end

  # source://inertia_rails//lib/inertia_rails/controller.rb#174
  def inertia_view_assigns; end

  # source://inertia_rails//lib/inertia_rails/controller.rb#155
  def precognition(model_or_errors); end
...
module InertiaRails::Controller::ClassMethods
  # source://inertia_rails//lib/inertia_rails/controller.rb#63
  def _inertia_configuration; end

  # source://inertia_rails//lib/inertia_rails/controller.rb#70
  ...
  # source://inertia_rails//lib/inertia_rails/controller.rb#56
  def use_inertia_instance_props; end

  private

  # source://inertia_rails//lib/inertia_rails/controller.rb#90
  ...
  # source://inertia_rails//lib/inertia_rails/controller.rb#84
  def push_to_inertia_share(**attrs, &block); end

  # source://inertia_rails//lib/inertia_rails/controller.rb#111
  def transform_inertia_share_option(options, from, to); end
end

# source://inertia_rails//lib/inertia_rails/current.rb#4
class InertiaRails::Current < ::ActiveSupport::CurrentAttributes
  class << self
    # source://inertia_rails//lib/inertia_rails/current.rb#5
...
class InertiaRails::DeferProp < ::InertiaRails::IgnoreOnFirstLoadProp
  ...
  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/defer_prop.rb#18
  def deferred?; end
...
# source://inertia_rails//lib/inertia_rails/errors.rb#6
class InertiaRails::DoublePrecognitionError < ::StandardError
  ...
  #
  # source://inertia_rails//lib/inertia_rails/errors.rb#7
  def initialize; end
end
...
# source://inertia_rails//lib/inertia_rails/errors.rb#4
...
module InertiaRails::InertiaRequest
  ...
  # @return [Boolean]
  #
  # source://inertia_rails//lib/patches/request.rb#13
  def inertia_precognitive?; end

  # source://inertia_rails//lib/patches/request.rb#17
...
class InertiaRails::Middleware::InertiaRailsRequest
  ...
  # source://inertia_rails//lib/inertia_rails/middleware.rb#102
  def copy_xsrf_to_csrf!; end

  # source://inertia_rails//lib/inertia_rails/middleware.rb#97
  ...
  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/middleware.rb#108
  def precognition_request?; end

  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/middleware.rb#112
...
# source://inertia_rails//lib/inertia_rails/precognition.rb#16
module InertiaRails::Precognition
  class << self
    # Returns filtered errors hash if precognition request, nil otherwise
    #
    # source://inertia_rails//lib/inertia_rails/precognition.rb#19
    ...
    #
    # source://inertia_rails//lib/inertia_rails/precognition.rb#54
    def ensure_single_precognition_call!; end

    # source://inertia_rails//lib/inertia_rails/precognition.rb#47
    def filter_errors(errors, request); end

    # @raise [ArgumentError]
    #
    # source://inertia_rails//lib/inertia_rails/precognition.rb#32
    def normalize_errors(errors); end
  end
end

# source://inertia_rails//lib/inertia_rails/precognition.rb#7
class InertiaRails::PrecognitionResponse < ::StandardError
  # @return [PrecognitionResponse] a new instance of PrecognitionResponse
  #
  # source://inertia_rails//lib/inertia_rails/precognition.rb#10
  def initialize(errors); end

  # Returns the value of attribute errors.
  #
  # source://inertia_rails//lib/inertia_rails/precognition.rb#8
  def errors; end
end
...
class InertiaRails::Renderer
  ...
  # source://inertia_rails//lib/inertia_rails/renderer.rb#274
  def except_once_keys; end

  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/renderer.rb#334
  def excluded_by_except_partial_keys?(path_with_prefixes); end

  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/renderer.rb#301
  def excluded_by_once_cache?(prop, path); end

  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/renderer.rb#330
  def excluded_by_only_partial_keys?(path_with_prefixes); end

  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/renderer.rb#317
  def excluded_by_partial_request?(path); end

  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/renderer.rb#310
  def explicitly_requested?(path); end

  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/renderer.rb#290
  ...
  # source://inertia_rails//lib/inertia_rails/renderer.rb#338
  def meta_tags; end

  # source://inertia_rails//lib/inertia_rails/renderer.rb#116
  def page; end

  # source://inertia_rails//lib/inertia_rails/renderer.rb#270
  def partial_except_keys; end

  # source://inertia_rails//lib/inertia_rails/renderer.rb#262
  def partial_keys; end

  # source://inertia_rails//lib/inertia_rails/renderer.rb#324
  ...
  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/renderer.rb#278
  ...
  # source://inertia_rails//lib/inertia_rails/renderer.rb#282
...
class InertiaRails::ScrollProp < ::InertiaRails::BaseProp
  ...
  #
  # source://inertia_rails//lib/inertia_rails/scroll_prop.rb#11
  def initialize(**props, &block); end

  # source://inertia_rails//lib/inertia_rails/scroll_prop.rb#27
  def call(controller); end

  # @return [Boolean]
  #
  # source://inertia_rails//lib/inertia_rails/scroll_prop.rb#23
  def deferred?; end
  ...
  # source://inertia_rails//lib/inertia_rails/scroll_prop.rb#33
  def metadata; end

  private

  # source://inertia_rails//lib/inertia_rails/scroll_prop.rb#39
