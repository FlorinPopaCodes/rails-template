...
class Anyway::Config
  ...
  class << self
    ...
    def configuration_sources; end

    # Sets the attribute configuration_sources
    #
    # @param value the value to set the attribute configuration_sources to.
    def configuration_sources=(_arg0); end
...
class Anyway::Env
  ...
  #
  # source://anyway_config//lib/anyway/env.rb#30
  def initialize(type_cast: T.unsafe(nil), env_container: T.unsafe(nil)); end

  # source://anyway_config//lib/anyway/env.rb#37
  def clear; end

  # Returns the value of attribute data.
  #
  # source://anyway_config//lib/anyway/env.rb#28
  def data; end
  ...
  # source://anyway_config//lib/anyway/env.rb#42
  def fetch(prefix); end

  # source://anyway_config//lib/anyway/env.rb#54
  ...
  # source://anyway_config//lib/anyway/env.rb#60
  def parse_env(prefix); end

  class << self
    # source://anyway_config//lib/anyway/env.rb#11
...
# source://anyway_config//lib/anyway/loaders/base.rb#4
...
# source://anyway_config//lib/anyway/loaders/doppler.rb#9
class Anyway::Loaders::Doppler < ::Anyway::Loaders::Base
  # source://anyway_config//lib/anyway/loaders/doppler.rb#23
  def call(env_prefix:, **_options); end

  private

  # source://anyway_config//lib/anyway/loaders/doppler.rb#46
  def fetch_doppler_config(url, token); end

  # source://anyway_config//lib/anyway/loaders/doppler.rb#36
  def parse_doppler_response(url:, token:); end

  class << self
    # Returns the value of attribute download_url.
    #
    # source://anyway_config//lib/anyway/loaders/doppler.rb#13
    ...
    #
    # source://anyway_config//lib/anyway/loaders/doppler.rb#14
    def token=(_arg0); end
  end
end

# source://anyway_config//lib/anyway/loaders/doppler.rb#10
...
# source://anyway_config//lib/anyway/loaders/env.rb#5
class Anyway::Loaders::Env < ::Anyway::Loaders::Base
  # source://anyway_config//lib/anyway/loaders/env.rb#6
  def call(env_prefix:, **_options); end
end

# source://anyway_config//lib/anyway/loaders.rb#12
class Anyway::Loaders::Registry
  # @return [Registry] a new instance of Registry
  #
  # source://anyway_config//lib/anyway/loaders.rb#15
  def initialize; end

  # source://anyway_config//lib/anyway/loaders.rb#24
  def append(id, handler = T.unsafe(nil), &block); end

  # source://anyway_config//lib/anyway/loaders.rb#52
  def delete(id); end

  # source://anyway_config//lib/anyway/loaders.rb#59
  def each(&block); end

  # source://anyway_config//lib/anyway/loaders.rb#65
  def freeze; end

  # @raise [ArgumentError]
  #
  # source://anyway_config//lib/anyway/loaders.rb#37
  def insert_after(another_id, id, handler = T.unsafe(nil), &block); end

  # @raise [ArgumentError]
  #
  # source://anyway_config//lib/anyway/loaders.rb#29
  def insert_before(another_id, id, handler = T.unsafe(nil), &block); end

  # source://anyway_config//lib/anyway/loaders.rb#63
  def keys; end

  # source://anyway_config//lib/anyway/loaders.rb#45
  ...
  #
  # source://anyway_config//lib/anyway/loaders.rb#13
  def registry; end

  private

  # source://anyway_config//lib/anyway/loaders.rb#75
  def find(id); end

  # @raise [ArgumentError]
  #
  # source://anyway_config//lib/anyway/loaders.rb#69
  def insert_at(index, id, handler); end
end

# source://anyway_config//lib/anyway/loaders/yaml.rb#10
class Anyway::Loaders::YAML < ::Anyway::Loaders::Base
  # source://anyway_config//lib/anyway/loaders/yaml.rb#17
  def call(config_path:, **_options); end

  private

  # source://anyway_config//lib/anyway/loaders/yaml.rb#44
  def config_with_env(config); end

  # @return [Boolean]
  #
  # source://anyway_config//lib/anyway/loaders/yaml.rb#33
  def environmental?(parsed_yml); end

  # source://anyway_config//lib/anyway/loaders/yaml.rb#74
  def load_base_yml(path); end

  # source://anyway_config//lib/anyway/loaders/yaml.rb#75
  def load_local_yml(path); end

  # source://anyway_config//lib/anyway/loaders/yaml.rb#77
  def local_config_path(path); end

  # source://anyway_config//lib/anyway/loaders/yaml.rb#52
  def parse_yml(path); end

  # source://anyway_config//lib/anyway/loaders/yaml.rb#81
  def relative_config_path(path); end

  class << self
    # source://anyway_config//lib/anyway/loaders/yaml.rb#14
...
# source://anyway_config//lib/anyway/rails/loaders/credentials.rb#6
class Anyway::Rails::Loaders::Credentials < ::Anyway::Loaders::Base
  ...
  # source://anyway_config//lib/anyway/rails/loaders/credentials.rb#52
  def credentials_path; end

  # source://anyway_config//lib/anyway/rails/loaders/credentials.rb#39
  def local_credentials(name); end
end

# source://anyway_config//lib/anyway/rails/loaders/credentials.rb#7
Anyway::Rails::Loaders::Credentials::LOCAL_CONTENT_PATH = T.let(T.unsafe(nil), String)

# source://anyway_config//lib/anyway/rails/loaders/secrets.rb#6
class Anyway::Rails::Loaders::Secrets < ::Anyway::Loaders::Base
  # source://anyway_config//lib/anyway/rails/loaders/secrets.rb#7
  def call(name:, **_options); end

  private

  # source://anyway_config//lib/anyway/rails/loaders/secrets.rb#24
  def secrets; end
end
