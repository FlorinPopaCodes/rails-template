...
# For RuboCop plugin
#
# source://test-prof//lib/test-prof.rb#6
module RuboCop; end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/line_range_helpers.rb#4
module RuboCop::Cop; end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/line_range_helpers.rb#5
...
#
# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/line_range_helpers.rb#6
class RuboCop::Cop::RSpec::AggregateExamples < ::RuboCop::Cop::Base
  ...
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples.rb#124
  def on_block(node); end

  private

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples.rb#172
  def aggregated_example(examples, metadata); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples.rb#166
  ...
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples.rb#147
  ...
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples.rb#156
  def example_clusters_for_autocorrect(example_node); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples.rb#162
  def message_for(example, first_example); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples.rb#187
  def new_body(node); end

  # Extracts and transforms the body, keeping proper indentation.
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples.rb#183
...
#
# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/its.rb#36
module RuboCop::Cop::RSpec::AggregateExamples::Its
  extend ::RuboCop::AST::NodePattern::Macros

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/its.rb#80
  def example_for_autocorrect?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/its.rb#88
  def its_with_multi_element_array_argument?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/its.rb#92
  def its_with_send_or_var_argument?(param0 = T.unsafe(nil)); end

  private

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/its.rb#63
  def example_metadata(example); end

  # @return [Boolean]
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/its.rb#70
  def its?(node); end

  # It's impossible to aggregate `its` body as is, it needs to be
  # converted to `expect(subject.something).to ...`
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/its.rb#43
  def new_body(node); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/its.rb#49
  def transform_its(body, arguments); end
end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/line_range_helpers.rb#8
module RuboCop::Cop::RSpec::AggregateExamples::LineRangeHelpers
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/line_range_helpers.rb#24
  def adjacent?(range, another_range); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/line_range_helpers.rb#13
  def range_for_replace(examples); end
end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples.rb#122
...
#   end
#
# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/matchers_with_side_effects.rb#34
module RuboCop::Cop::RSpec::AggregateExamples::MatchersWithSideEffects
  include ::RuboCop::Cop::RSpec::Language
  extend ::RuboCop::AST::NodePattern::Macros

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/matchers_with_side_effects.rb#61
  def example_for_autocorrect?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/matchers_with_side_effects.rb#66
  def example_with_side_effects?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/matchers_with_side_effects.rb#71
  def expectation_with_side_effects?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/matchers_with_side_effects.rb#76
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/matchers_with_side_effects.rb#55
  def matcher_with_side_effects_name?(matcher_name); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/matchers_with_side_effects.rb#50
  def matcher_with_side_effects_names; end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/matchers_with_side_effects.rb#44
  def message_for(example, first_example); end
end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/matchers_with_side_effects.rb#38
...
# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/metadata_helpers.rb#13
module RuboCop::Cop::RSpec::AggregateExamples::MetadataHelpers
  private

  # @return [Boolean]
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/metadata_helpers.rb#60
  def add_aggregate_failures_metadata?; end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/metadata_helpers.rb#42
  def example_metadata(example); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/metadata_helpers.rb#16
  def metadata_for_aggregated_example(metadata); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/metadata_helpers.rb#52
  def metadata_pairs_without_aggegate_failures(metadata); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/metadata_helpers.rb#46
  ...
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/metadata_helpers.rb#33
  def metadata_without_aggregate_failures(example); end
end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#11
module RuboCop::Cop::RSpec::AggregateExamples::NodeMatchers
  include ::RuboCop::Cop::RSpec::Language
  extend ::RuboCop::AST::NodePattern::Macros

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#33
  def example_for_autocorrect?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#17
  def example_group_with_several_examples(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#48
  def example_has_title?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#41
  def example_with_expectations_only?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#65
  def expectation?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#72
  def single_expectation?(param0 = T.unsafe(nil)); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#61
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#57
  def contains_heredoc?(node); end

  # @return [Boolean]
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/aggregate_examples/node_matchers.rb#25
  def example_method?(method_name); end
end

# RSpec public API methods that are commonly used in cops
#
# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#9
module RuboCop::Cop::RSpec::Language; end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#51
module RuboCop::Cop::RSpec::Language::ExampleGroups; end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#56
RuboCop::Cop::RSpec::Language::ExampleGroups::ALL = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#54
RuboCop::Cop::RSpec::Language::ExampleGroups::FOCUSED = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#52
RuboCop::Cop::RSpec::Language::ExampleGroups::GROUPS = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#53
RuboCop::Cop::RSpec::Language::ExampleGroups::SKIPPED = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#59
module RuboCop::Cop::RSpec::Language::Examples; end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#65
RuboCop::Cop::RSpec::Language::Examples::ALL = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#60
RuboCop::Cop::RSpec::Language::Examples::EXAMPLES = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#61
RuboCop::Cop::RSpec::Language::Examples::FOCUSED = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#63
RuboCop::Cop::RSpec::Language::Examples::PENDING = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#62
RuboCop::Cop::RSpec::Language::Examples::SKIPPED = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#10
RuboCop::Cop::RSpec::Language::RSPEC = T.let(T.unsafe(nil), String)

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#68
module RuboCop::Cop::RSpec::Language::Runners; end

# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#69
RuboCop::Cop::RSpec::Language::Runners::ALL = T.let(T.unsafe(nil), RuboCop::Cop::RSpec::Language::SelectorSet)

# Set of method selectors
#
# source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#13
class RuboCop::Cop::RSpec::Language::SelectorSet
  # @return [SelectorSet] a new instance of SelectorSet
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#14
  def initialize(selectors); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#22
  def +(other); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#18
  def ==(other); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#30
  def block_pattern; end

  # @return [Boolean]
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#26
  def include?(selector); end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#42
  def node_pattern; end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#38
  def node_pattern_union; end

  # source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#34
  ...
  #
  # source://test-prof//lib/rubocop/test_prof/cops/rspec/language.rb#48
  def selectors; end
end

# source://test-prof//lib/rubocop/test_prof/plugin.rb#6
module RuboCop::TestProf; end

# A plugin that integrates TestProf with RuboCop's plugin system.
#
# source://test-prof//lib/rubocop/test_prof/plugin.rb#8
class RuboCop::TestProf::Plugin < ::LintRoller::Plugin
  # source://test-prof//lib/rubocop/test_prof/plugin.rb#9
  def about; end

  # source://test-prof//lib/rubocop/test_prof/plugin.rb#22
  def rules(_context); end

  # @return [Boolean]
  #
  # source://test-prof//lib/rubocop/test_prof/plugin.rb#18
...
# source://test-prof//lib/test_prof/factory_bot.rb#7
...
module TestProf::FactoryDoctor
  ...
  class << self
    # source://test-prof//lib/test_prof/factory_doctor.rb#58
    def config; end

    # @yield [config]
    #
    # source://test-prof//lib/test_prof/factory_doctor.rb#62
    def configure; end

    # Returns the value of attribute count.
    #
    # source://test-prof//lib/test_prof/factory_doctor.rb#56
    def count; end

    # Do not analyze code within the block
    #
    # source://test-prof//lib/test_prof/factory_doctor.rb#107
    def ignore; end
    ...
    #
    # source://test-prof//lib/test_prof/factory_doctor.rb#67
    def init; end
    ...
    # source://test-prof//lib/test_prof/factory_doctor.rb#102
    def result; end

    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/factory_doctor.rb#89
    def stamp?; end

    # source://test-prof//lib/test_prof/factory_doctor.rb#93
    def start; end

    # source://test-prof//lib/test_prof/factory_doctor.rb#98
    def stop; end
...
class TestProf::FactoryDoctor::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # source://test-prof//lib/test_prof/factory_doctor.rb#45
  def initialize; end

  # Returns the value of attribute event.
  #
  # source://test-prof//lib/test_prof/factory_doctor.rb#43
  def event; end
...
module TestProf::FactoryProf
  ...
  class << self
    # source://test-prof//lib/test_prof/factory_prof.rb#83
    def config; end

    # @yield [config]
    #
    # source://test-prof//lib/test_prof/factory_prof.rb#87
    def configure; end

    # Patch factory lib, init vars
    #
    # source://test-prof//lib/test_prof/factory_prof.rb#92
    def init; end

    # source://test-prof//lib/test_prof/factory_prof.rb#100
    def patch!; end

    # source://test-prof//lib/test_prof/factory_prof.rb#122
    def print(started_at); end

    # source://test-prof//lib/test_prof/factory_prof.rb#137
    def result; end

    # Inits FactoryProf and setups at exit hook,
    # then runs
    #
    # source://test-prof//lib/test_prof/factory_prof.rb#110
    def run; end

    # source://test-prof//lib/test_prof/factory_prof.rb#128
    def start; end

    # source://test-prof//lib/test_prof/factory_prof.rb#133
    def stop; end

    # source://test-prof//lib/test_prof/factory_prof.rb#141
    def track(factory, variation:); end

    private

    # source://test-prof//lib/test_prof/factory_prof.rb#201
    def flush_stack; end

    # source://test-prof//lib/test_prof/factory_prof.rb#180
    def hash_template(name); end

    # source://test-prof//lib/test_prof/factory_prof.rb#169
    def reset!; end

    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/factory_prof.rb#207
    def running?; end

    # source://test-prof//lib/test_prof/factory_prof.rb#190
    def track_count(factory); end

    # source://test-prof//lib/test_prof/factory_prof.rb#195
    def track_time(factory, t1, t2); end

    # source://test-prof//lib/test_prof/factory_prof.rb#161
...
class TestProf::FactoryProf::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#22
  def initialize; end
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#46
  def include_variations?; end
  ...
  # Sets the attribute truncate_names
  #
  # @param value the value to set the attribute truncate_names to.
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#19
...
module TestProf::FactoryProf::Printers::Simple
  ...
  class << self
    ...
    # source://test-prof//lib/test_prof/factory_prof/printers/simple.rb#79
    def format_args(stat); end

    # source://test-prof//lib/test_prof/factory_prof/printers/simple.rb#87
    def format_string(indent_len, name_len, truncate_names); end

    # source://test-prof//lib/test_prof/factory_prof/printers/simple.rb#75
...
class TestProf::FactoryProf::Result
  # @return [Result] a new instance of Result
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#54
  ...
  # source://test-prof//lib/test_prof/factory_prof.rb#71
  def total_count; end

  # source://test-prof//lib/test_prof/factory_prof.rb#75
  def total_time; end
end
...
class TestProf::MemoryProf::AllocPrinter < ::TestProf::MemoryProf::Printer
  ...
  # source://test-prof//lib/test_prof/memory_prof/printer.rb#75
  def memory_amount(item); end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#67
  def mode; end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#71
  def print_total; end
end
...
class TestProf::MemoryProf::Printer
  ...
  #
  # source://test-prof//lib/test_prof/memory_prof/printer.rb#13
  def initialize(tracker); end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#17
  def print; end

  private

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#53
  def memory_percentage(item); end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#59
  def number_to_human(value); end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#32
  def print_block(name, items); end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#42
  def print_items(items); end

  # Returns the value of attribute tracker.
  #
  # source://test-prof//lib/test_prof/memory_prof/printer.rb#30
  def tracker; end
end
...
class TestProf::MemoryProf::RssPrinter < ::TestProf::MemoryProf::Printer
  ...
  # source://test-prof//lib/test_prof/memory_prof/printer.rb#91
  def memory_amount(item); end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#83
  def mode; end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#87
  def print_total; end
end
...
class TestProf::TPSProf::Reporter::Text
  ...
  # source://test-prof//lib/test_prof/tps_prof/reporter/text.rb#15
...
module TestProf::TagProf::Printers::Simple
  ...
  class << self
    # source://test-prof//lib/test_prof/tag_prof/printers/simple.rb#13
    def dump(result); end
  end
end
